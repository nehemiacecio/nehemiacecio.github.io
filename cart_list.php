	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p> <b><small>Unit Price :<?php echo "Rp".number_format($row['price'],3) ?></small></b></p>
			        			<p><small>QTY :</small></p>
			        		...
			        		<div class="col-md-4 text-right">
			        			<b><large><?php echo "Rp".number_format($row['qty'] * $row['price'],3) ?></large></b>
			        		</div>
		        		</div>
	        		</div>
	        	</div>
        		...
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					...
        					<hr>
        					<p class="text-right"><b><?php echo "Rp".number_format($total,3) ?></b></p>
        					<hr>
